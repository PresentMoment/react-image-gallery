...
var imageSetType = (0, _propTypes.arrayOf)(
  (0, _propTypes.shape)({
...
var ImageGallery = (function (_React$Component) {
  ...
  function ImageGallery(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ImageGallery.__proto__ || Object.getPrototypeOf(ImageGallery)).call(
        this,
        props
      )
    );
    ...
    _this.slideToIndex = (0, _lodash2.default)(
      _this.unthrottledSlideToIndex,
      props.slideDuration,
      { trailing: false }
    );
  ...
  _createClass(ImageGallery, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        var loaded = prevProps.isLoaded !== this.state.isLoaded;
        ...
        if (prevProps.slideDuration !== slideDuration) {
          this.slideToIndex = (0, _lodash2.default)(
    ...
    },
    {
      ...
      value: function getThumbnailStyle() {
        ...
        var verticalTranslateValue = isRTL
          ? thumbsTranslate * -1
          : thumbsTranslate;
    ...
    },
    {
      ...
      value: function getSlideItems() {
        ...
        items.forEach(function (item, index) {
          ...
          var originalClass = item.originalClass
            ? " " + item.originalClass
            : "";
          var thumbnailClass = item.thumbnailClass
            ? " " + item.thumbnailClass
            : "";
          var handleRenderItem =
            item.renderItem || renderItem || _this4.renderItem;
          var handleRenderThumbInner =
            item.renderThumbInner ||
            renderThumbInner ||
            _this4.renderThumbInner;
            ...
            thumbnails.push(
              _react2.default.createElement(
                "button",
                {
                  ...
                  onMouseLeave: slideOnThumbnailOver
                    ? _this4.onThumbnailMouseLeave
                    : null,
          ...
          if (showBullets) {
            ...
            var igBulletClass = (0, _clsx2.default)(
    ...
    },
    {
      ...
      */
        ...
        var notGoingFromFirstToLast = !(
          previousIndex === 0 && currentIndex === totalSlides
        );
        var notGoingFromLastToFirst = !(
    ...
    },
    {
      ...
      */
        ...
        var indexIsNotPreviousOrNextSlide = !(
      ...
      value: function handleSwiping(_ref) {
        ...
        if (!isTransitioning && !scrollingUpDown) {
          ...
          var swipingTransition = {
            transition:
              "transform " + swipingTransitionDuration + "ms ease-out",
          };
    ...
    },
    {
      ...
      value: function handleOnSwiped(_ref2) {
        ...
        if (!scrollingUpDown) {
          ...
          var swipeDirection =
            (dir === _reactSwipeable.LEFT ? 1 : -1) * (isRTL ? -1 : 1);
    ...
    },
    {
      ...
      value: function handleResize() {
        ...
        if (this.thumbnailsWrapper && this.thumbnailsWrapper.current) {
          if (this.isThumbnailVertical()) {
            this.setState({
              thumbnailsWrapperHeight: this.thumbnailsWrapper.current
                .offsetHeight,
            });
          } else {
            this.setState({
              thumbnailsWrapperWidth: this.thumbnailsWrapper.current
                .offsetWidth,
            });
          }
        }
    ...
    },
    {
      ...
      value: function initResizeObserver(element) {
        ...
        this.resizeObserver = new _resizeObserverPolyfill2.default(
          (0, _lodash4.default)(function (entries) {
            if (!entries) return;
    ...
    },
    {
      ...
      value: function render() {
        ...
        var igContentClass = (0, _clsx2.default)(
